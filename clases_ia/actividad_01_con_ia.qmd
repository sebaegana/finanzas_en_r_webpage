---
listing_title: "02 - Actividad 01 - Limpieza de Datos (Manual vs IA)"
title: |
  Limpieza y Exploración de Datos
subtitle: "Actividad 01: Comparación Manual vs Asistido con IA"
author:
...
**Contexto**: Tienes un dataset sobre estadísticas de mujeres en ajedrez de diferentes federaciones mundiales.
Tu tarea es:
...
- Descarga el dataset `chess_women.xlsx`

**Paso 2: Usa Claude Code para exploración inicial**

Abre Claude Code en Positron y pide:

> "Carga chess_women.xlsx y dame un resumen inicial:
...
> "Necesito un análisis completo de chess_women.xlsx:
> 1. Carga ambas hojas
