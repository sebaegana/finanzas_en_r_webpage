---
listing_title: "02 - Stack Tecnológico"
title: |
...
<div style="margin-bottom: 20px; display: flex; gap: 10px;">
  <a href="herramientas.pdf" class="btn btn-primary" role="button" style="padding: 8px 16px; border-radius: 4px; background-color: #0d6efd; color: white; text-decoration: none;">📄 Descargar PDF</a>
  <a href="herramientas.qmd" class="btn btn-secondary" role="button" style="padding: 8px 16px; border-radius: 4px; background-color: #6c757d; color: white; text-decoration: none;">💾 Descargar Fuente</a>
</div>
```
...
☐ Activar Claude Code (gratis con 2M tokens/mes)
  → O: Crear cuenta en Mistral (gratis, sin tarjeta)
☐ Opcional: VS Code (alternativa a Positron)
```

**Tiempo de instalación:** ~45 min
**Costo:** Gratis o $20/mes (Claude Pro)
...
- Soporte nativo para IA (Claude Code)
