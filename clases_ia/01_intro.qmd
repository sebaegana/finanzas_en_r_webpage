---
listing_title: "01 - Introducción a Finanzas en R"
title: |
...
<div style="margin-bottom: 20px; display: flex; gap: 10px;">
  <a href="intro.pdf" class="btn btn-primary" role="button" style="padding: 8px 16px; border-radius: 4px; background-color: #0d6efd; color: white; text-decoration: none;">📄 Descargar PDF</a>
  <a href="intro.qmd" class="btn btn-secondary" role="button" style="padding: 8px 16px; border-radius: 4px; background-color: #6c757d; color: white; text-decoration: none;">💾 Descargar Fuente</a>
</div>
```
