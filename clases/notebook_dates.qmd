---
listing_title: "Revisar - Clase 01 - Notebook Dates"
title: |
  Finanzas en R - Notebook Dates
...
La librerÃ­a mÃ¡s utilizada para lidiar con fechas en R, corresponde a lubridate [enlace](https://lubridate.tidyverse.org), que es parte de tidyverse.
...
Como ventaja, lubridate deberÃ­a reconocer de manera automÃ¡tica los separadores normalmente usado en formatos de fecha.
...
### Â¿CÃ³mo harÃ­amos esto con lubridate?
...
### Â¿Esto es una soluciÃ³n definitiva?
...
Esto es un caso particular, que por lo general lleva a errores. AÃ±ademos una funciÃ³n de leading zeros:
...
Cabe mencionar que `str_pad` permite aÃ±adir ya sean 0 a la izquierda, a la derecha, o ambos lados.
...
Utilizando la librerÃ­a bÃ¡sica de fechas:
...
En el caso de aÃ±adir tiempo, los formatos por defecto de R deben considerar que sean tipo POSIXct y no Date (producidos por `as.Date`)
