...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, boxrule=0pt, sharp corners, borderline west={3pt}{0pt}{shadecolor}, interior hidden, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
\begin{verbatim}
                SPY      EFA      IJS      EEM      AGG
2012-12-31 113.6952 38.59528 33.11092 33.22222 78.67467
2013-01-31 119.5153 40.03428 34.88289 33.12486 78.18595
2013-02-28 121.0403 39.51841 35.45171 32.36827 78.64789
\end{verbatim}
...
\begin{verbatim}
                  SPY         EFA        IJS          EEM           AGG
2013-01-31 0.04992318  0.03660617 0.05213351 -0.002935062 -0.0062312352
2013-02-28 0.01267859 -0.01296943 0.01617506 -0.023105377  0.0058907987
2013-03-31 0.03726751  0.01296943 0.04025811 -0.010234933  0.0009847179
\end{verbatim}
...
\begin{verbatim}
                 returns
2013-01-31  0.0308489045
2013-02-28 -0.0008696911
2013-03-31  0.0186623403
\end{verbatim}
...
# Groups:   asset [5]
 ...
 1 SPY   (Intercept)                   0         0            0.320   0.749 
 2 SPY   market_returns_tidy$returns   1         0      1305455.      0     
...
asset & term & estimate & std.error & statistic & p.value\\
\midrule
SPY & (Intercept) & 0.00 & 0.00 & 0.32 & 0.75\\
SPY & market\_returns\_tidy\$returns & 1.00 & 0.00 & 1305455.01 & 0.00\\
