...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, frame hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, interior hidden, breakable]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
\begin{verbatim}
                SPY      EFA      IJS      EEM      AGG
2012-12-31 114.0312 39.29465 33.26601 33.69767 79.71034
2013-01-31 119.8685 40.75972 35.04625 33.59888 79.21517
2013-02-28 121.3979 40.23451 35.61777 32.83149 79.68325
\end{verbatim}
...
\begin{verbatim}
                  SPY         EFA        IJS          EEM           AGG
2013-01-31 0.04992323  0.03660594 0.05213266 -0.002935826 -0.0062315003
2013-02-28 0.01267811 -0.01296910 0.01617589 -0.023104770  0.0058915622
2013-03-31 0.03726776  0.01296910 0.04025809 -0.010235228  0.0009851294
\end{verbatim}
...
\begin{verbatim}
                 returns
2013-01-31  0.0308485077
2013-02-28 -0.0008693674
2013-03-31  0.0186622988
\end{verbatim}
...
# Groups:   asset [5]
 ...
 1 SPY   (Intercept)                   0         0            0.195   0.846 
 2 SPY   market_returns_tidy$returns   1         0      1263951.      0     
...
asset & term & estimate & std.error & statistic & p.value\\
\midrule
SPY & (Intercept) & 0.00 & 0.00 & 0.19 & 0.85\\
SPY & market\_returns\_tidy\$returns & 1.00 & 0.00 & 1263951.27 & 0.00\\
