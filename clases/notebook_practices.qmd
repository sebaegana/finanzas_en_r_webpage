...
## ¿Cómo se instalan paquetes en R?

Los paquetes amplían las capacidades de R y se descargan desde CRAN.
...
Antes de instalar, revisa si Git ya está disponible en tu sistema:
...
Opción recomendada usando Homebrew:
