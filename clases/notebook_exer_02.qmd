---
listing_title: "Revisar - Clase 03 - Notebook Ejercicio 01"
title: "Finanzas en R"
...
3.  Calculamos la desviaciÃ³n estÃ¡ndar
...
## DesempeÃ±o de un activo

Veamos el desempeÃ±o de un activo financiero versus su benchmark conocido:
...
Calculemos algunas mÃ©tricas de comparaciÃ³n:
...
Consideramos que un Alpha positivo corresponde un desempeÃ±o por encima del benchmark.
...
La comparaciÃ³n implica un menor retorno en relaciÃ³n a cada unidad de riesgo, siendo el riesgo medido en base al beta.
...
ReflexiÃ³n parecida a la del Treynor ratio.
...
Esto corresponde una metrÃ­ca distinta de evaluaciÃ³n.
