...
dm_export_graph(graph, 'imagenes/diagrama_01.svg')
```

![Diagrama 01](imagenes/diagrama_01.svg){width="50%"}
...
dm_export_graph(graph, 'imagenes/diagrama_02.svg')

```

![Diagrama 02](imagenes/diagrama_02.svg){width="70%"}
...
graph <- dm_create_graph(dm_f, rankdir = "BT", col_attr = c("column", "type"))
#dm_render_graph(graph)
dm_export_graph(graph, 'imagenes/diagrama_03.svg')

```

![Diagrama 03](imagenes/diagrama_03.svg){width="50%"}
...
#dm_render_graph(graph)
dm_export_graph(graph, 'imagenes/diagrama_04.svg')


```

![Diagrama 04](imagenes/diagrama_04.svg){width="70%"}
